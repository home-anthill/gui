          ...
          <div className={styles['sensor-header']}>
            {(() => {
              switch (props.feature.name) {
                case 'temperature':
                  return (
                    <DeviceThermostatIcon fontSize="large"></DeviceThermostatIcon>
                  );
                case 'humidity':
                  ...
                  default:
                    return (
                      <Typography
                        ...
                        gutterBottom
                      >
                        Unsupported sensor feature = {props.feature.name}
                      </Typography>
                    );
                }
              }
